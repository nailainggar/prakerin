    ...
    <div class="scrollbar-inner">
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" href="{{route('provinsi.index')}}">
                <i class="ni ni-tv-2 text-primary"></i>
                <span class="nav-link-text">Provinsi</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" href="{{route('kota.index')}}">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{route('kasus2.index')}}">
                <i class="ni ni-key-25 text-info"></i>
                <span class="nav-link-text">Kasus2</span>
              </a>
            </li>
            <li class="nav-item">
